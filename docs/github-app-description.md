Run GitHub Actions on your Mac — **localmost** manages everything for you.

Org Permissions
- Read and write access to self-hosted runners (to register runner)
- Read and write access to action variables (to set runner-check timestamp)
